        ...
        auth.createUserWithEmailAndPassword(textEmail, textPWD).addOnCompleteListener(Register.this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                        ...
                        DatabaseReference referenceProfile = FirebaseDatabase.getInstance("https://donthrow-app-2amavs-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("Registered Users");
