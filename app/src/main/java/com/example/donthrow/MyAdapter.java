...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ProductViewHolder> {
    ...
    private void navigateToMLTDetails(String name, String category, double price, String condition, String productLocation, String postage, String imageUrl, String productId) {
        if (context instanceof FragmentActivity) {
            ...
            bundle.putString("productLocation", productLocation);
