...
import com.example.donthrow.models.Product; import com.example.donthrow.models.Product_Firebase; import com.squareup.picasso.Picasso;
...
public class ProductDetailsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button buyButton = view.findViewById(R.id.buy_now_button);
                ...
                public void onProductsFetched(List<Product> products) {
                    for (Product product : products) {
                        if (product.getName().equals(name)) {
                            ...
                            usefulForTextDetails.setText(product.getCondition());
                            dosageTextDetails.setText(product.getProductLocation());
        ...
        addToCartButton.setOnClickListener(v -> {
            Log.d("ProductDetailsFragment", "Add to cart button clicked for product ID: " + productId);
            if (productId != null) {
                cartManager.addToCart(productId);
                Toast.makeText(requireContext(), "Added to cart!", Toast.LENGTH_SHORT).show(); // Show the Toast message
            } else {
                Log.e("ProductDetailsFragment", "Product ID is null, cannot add to cart.");
            }
        });
